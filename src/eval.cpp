...
const int mg_bishop_atk = 2;
const int mg_rook_atk = 2;
const int mg_queen_atk = -2;
...
int eval(const Board &board)
{
	...
	const int mg_eval = info.mg + mg_bishop_atk * bishop_atk_cnt + mg_rook_atk * rook_atk_cnt + mg_queen_atk * queen_atk_cnt;
	const int eg_eval = info.eg + eg_bishop_atk * bishop_atk_cnt + eg_rook_atk * rook_atk_cnt + eg_queen_atk * queen_atk_cnt;
