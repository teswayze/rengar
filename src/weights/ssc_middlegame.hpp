...
const int ssc_mg_pawn = 71;
const int ssc_mg_knight = 309;
const int ssc_mg_bishop = 291;
const int ssc_mg_rook = 396;
const int ssc_mg_queen = 846;
const int ssc_mg_bishop_pair = 5;

// All tables can be viewed from white's perspective with both kings on the kingside

const std::array<int, 64> ssc_mg_pawn_table = {
	  0,   0,   0,   0,   0,   0,   0,   0,
...
const std::array<int, 64> ssc_mg_knight_table = {
...
const std::array<int, 64> ssc_mg_bishop_table = {
...
const std::array<int, 64> ssc_mg_rook_table = {
...
const std::array<int, 64> ssc_mg_queen_table = {
...
const std::array<int, 64> ssc_mg_king_table = {
	  0,   0,   0,   0, -64, -33,  -7,  -3,
	  0,   0,   0,   0, -23, -24, -46, -36,
	  0,   0,   0,   0, -20, -11,  -9, -23,
	  0,   0,   0,   0, -25, -37, -29, -51,
