...
TEST_CASE("Least valuable attacker"){
	Attacks attacks = {
			RANK_5 | RANK_6 | RANK_7 | RANK_8,
			RANK_3 | RANK_4 | RANK_7 | RANK_8,
			RANK_2 | RANK_4 | RANK_6 | RANK_8,
			E_FILE | F_FILE | G_FILE | H_FILE,
			C_FILE | D_FILE | G_FILE | H_FILE,
			B_FILE | D_FILE | F_FILE | H_FILE,
	};

	CHECK(least_valuable_attacker_at_square(attacks, A1) == 0);
	CHECK(least_valuable_attacker_at_square(attacks, B1) == 1);
	CHECK(least_valuable_attacker_at_square(attacks, C1) == 2);
	CHECK(least_valuable_attacker_at_square(attacks, D1) == 2);
	CHECK(least_valuable_attacker_at_square(attacks, E1) == 3);
	CHECK(least_valuable_attacker_at_square(attacks, F1) == 3);
	CHECK(least_valuable_attacker_at_square(attacks, G1) == 3);
	CHECK(least_valuable_attacker_at_square(attacks, H1) == 3);

	CHECK(least_valuable_attacker_at_square(attacks, A2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, B2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, C2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, D2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, E2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, F2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, G2) == 4);
	CHECK(least_valuable_attacker_at_square(attacks, H2) == 4);

	CHECK(least_valuable_attacker_at_square(attacks, A3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, B3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, C3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, D3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, E3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, F3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, G3) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, H3) == 5);

	CHECK(least_valuable_attacker_at_square(attacks, A4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, B4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, C4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, D4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, E4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, F4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, G4) == 5);
	CHECK(least_valuable_attacker_at_square(attacks, H4) == 5);

	CHECK(least_valuable_attacker_at_square(attacks, A5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, B5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, C5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, D5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, E5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, F5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, G5) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, H5) == 6);

	CHECK(least_valuable_attacker_at_square(attacks, A6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, B6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, C6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, D6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, E6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, F6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, G6) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, H6) == 6);

	CHECK(least_valuable_attacker_at_square(attacks, A7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, B7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, C7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, D7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, E7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, F7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, G7) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, H7) == 6);

	CHECK(least_valuable_attacker_at_square(attacks, A8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, B8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, C8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, D8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, E8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, F8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, G8) == 6);
	CHECK(least_valuable_attacker_at_square(attacks, H8) == 6);
}
